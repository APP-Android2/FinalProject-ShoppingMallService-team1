...
class MainActivity : AppCompatActivity() {
    ...
    fun replaceFragment(name:MAIN_FRAGMENT_NAME, addToBackStack:Boolean, isAnimate:Boolean, data:Bundle?){
        ...
        when(name){
            ...
            // 권한 화면
            MAIN_FRAGMENT_NAME.PERMISSION_FRAGMENT -> {
            }

            // 회원 설명 화면
            MAIN_FRAGMENT_NAME.MEMBER_EXPLANATION_FRAGMENT -> {
                CenterFragment()
            }
